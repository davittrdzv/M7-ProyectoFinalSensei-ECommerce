...
const ProductCardHome = ({ image, name, description, price }) => {
  return (
    <div className='col'>
      <div className='card h-100'>
        ...
        <div className='card-body d-flex flex-column'>
          ...
          <h6 className='card-text'>{price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
          </h6>
          <div className='d-flex justify-content-around gap-2'>
            <Link to='/about' className='btn btn-primary w-100'>Details</Link>
